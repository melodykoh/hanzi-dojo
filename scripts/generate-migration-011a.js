/**
 * Generate Migration 011a - Dictionary Quality Phase 1
 *
 * Reads multi_pronunciation_phase1.json and generates SQL migration
 * to update dictionary entries with proper zhuyin_variants structure.
 *
 * Usage: node scripts/generate-migration-011a.js
 */
...
const researchPath = path.join(__dirname, '../data/multi_pronunciation_phase1.json');
...
const migrationHeader = `-- Migration 011a: Dictionary Quality - Phase 1
-- Date: ${research.date}
...
--
-- Source: Epic 8 Phase 1 Research
-- Reference: data/multi_pronunciation_phase1.json
--
-- Database Safety Protocol:
-- 1. Backup completed: data/backups/dictionary_backup_pre_011a_*.json
...
const migrationPath = path.join(__dirname, '../supabase/migrations/011a_dictionary_quality_phase1.sql');
fs.writeFileSync(migrationPath, migrationHeader, 'utf8');

console.log('✅ Migration 011a generated successfully!');
...
console.log('2. Test on local Supabase: psql < supabase/migrations/011a_dictionary_quality_phase1.sql');
